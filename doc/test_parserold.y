...
%type <expr> DECL_LIST STMT_LIST EXPR_STMT SELEC_STMT ITER_STMT JMP_STMT ROOT_NODE
%type <expr> STMT LBL_STMT COMP_STMT
...
%token T_PLUS T_MINUS T_MULT T_DIV T_STAR T_EXPONENT T_MOD
...
INCL_OR_EXPR
	: EXCL_OR_EXPR
	| INCL_OR_EXPR T_BWOR EXCL_OR_EXPR
	;
...
: DECL_SPECS T_SEMI
	: DECL_SPECS T_SEMI
	| DECL_SPECS INIT_DECL_LIST T_SEMI
	;
...
INIT_DECL_LIST
	: INIT_DECL
	| INIT_DECL_LIST T_COMM INIT_DECL
	;
...
STRUCT_DECL
	: SPEC_QUAL_LIST STRUCT_DECL_LIST T_SEMI
	;
...
STRUCT_DECL_LIST
	: STRUCT_DECL
	| STRUCT_DECL_LIST T_COMM STRUCT_DECL
	;

STRUCT_DECL
	: DECL
	| T_QEND CONST_EXPR
	| DECL T_QEND CONST_EXPR
	;
...
DIREC_DECL
	: T_IDENTIFIER
	| T_LBRACKET DECL T_RBRACKET
	| DIREC_DECL T_LSQBRACKET CONST_EXPR T_RSQBRACKET
	| DIREC_DECL T_LSQBRACKET T_RSQBRACKET
	| DIREC_DECL T_LBRACKET PARAM_TYPE_LIST T_RBRACKET
	| DIREC_DECL T_LBRACKET ID_LIST T_RBRACKET
	| DIREC_DECL T_LBRACKET T_RBRACKET
	;
...
TYPE_NAME
	: SPEC_QUAL_LIST
	| SPEC_QUAL_LIST ABST_DECL
	;

ABST_DECL
	: POINTER
	| DIR_ABST_DECL
	| POINTER DIR_ABST_DECL
	;

DIR_ABST_DECL
	: T_LBRACKET ABST_DECL T_RBRACKET
	| T_LSQBRACKET T_RSQBRACKET
	| T_LSQBRACKET CONST_EXPR T_RSQBRACKET
	| DIR_ABST_DECL T_LSQBRACKET T_RSQBRACKET
	| DIR_ABST_DECL T_LSQBRACKET CONST_EXPR T_RSQBRACKET
	| T_LBRACKET T_RBRACKET
	| T_LBRACKET PARAM_TYPE_LIST T_RBRACKET
	| DIR_ABST_DECL T_LBRACKET T_RBRACKET
	| DIR_ABST_DECL T_LBRACKET PARAM_TYPE_LIST T_RBRACKET
	;
